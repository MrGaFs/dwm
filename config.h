...
static const char col_4[]  = "#a204a1"; /* border color focused windows and tags */
/* bar opacity 
...
static const char *dmenucmd[]    = {"dmenu_run","-nf","#F8F8F2","-nb","#282A36","-sb","#6272A4","-sf","#F8F8F2","-fn","JetBrains-10","-p","dmenu : ",NULL,};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_c,		spawn,			CMD("code") },
	{ MODKEY,			XK_m,		spawn,			CMD("spotify") },
	{ MODKEY,			XK_p,		spawn,			CMD("vlc $(xclip -o)") },
	{ MODKEY,			XK_space,	spawn,			CMD("pkill -RTMIN+26 dwmblocks") },
	{ MODKEY|ShiftMask,	XK_p,		spawn,			CMD("alacritty -e yt-d $(xclip -o)") },
	{ MODKEY|ShiftMask,	XK_q,		spawn,			CMD("shuty") },
	{ 0,XF86XK_AudioRaiseVolume,	spawn,			CMD("volume_change up") },
	{ 0,XF86XK_AudioLowerVolume,	spawn,			CMD("volume_change down") },
	{ 0,XF86XK_AudioMute,			spawn,			CMD("volume_change toggle") },
    ...
    /*XF86AudioPrev	     Dmenu scripts launched with ALT + CTRL + KEY */
